...
add_definitions(
	...
	/D "BOOST_FILESYSTEM_VERSION=3"
)

# set_property ( GLOBAL APPEND PROPERTY COMPILE_DEFINITIONS "/D_WIN32_WINNT=0x501")
...
firebreath_sign_plugin(${PROJECT_NAME}
    "${CERT_DIR}/UntrixCert.pfx"
    "${CERT_DIR}/UntrixPass.txt"
...
add_wix_installer( ${PLUGIN_NAME}
    ${CMAKE_CURRENT_SOURCE_DIR}/Win/WiX/BPrivyInstaller.wxs
    PluginDLLGroup
