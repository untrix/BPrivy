...
8.2. Download and install Wix 3.5 (not 3.6). Get it from the BPrivy downloads DVD or download from http://wixtoolset.org (be sure to only install v3.5, later versions won't work). NOTE: This must be done before the next step, otherwise the installer project won't be generated.
